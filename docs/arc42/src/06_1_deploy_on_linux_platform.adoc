...
| | | ONLINE_BANKING_SCA_LOGINPAGE | https://demo-dynamicsandbox-onlinebankingui-cloud-OFIN.co/ (example) | Online-banking page, to which user would be redirected in Redirect approach
...
| | | MANAGEMENT_ENDPOINTS_WEB_CORS_ALLOWED_ORIGINS | https://demo-dynamicsandbox-onlinebankingui-cloud-OFIN.co | CORS settings
