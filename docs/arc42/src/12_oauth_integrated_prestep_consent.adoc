...
[start=1]
. Click on: https://dev-dynamicsandbox-tppui.cloud.OFIN.co/login and register a new TPP account.
...
"tppMessages": [
    {
        "category": "ERROR",
        "code": "UNAUTHORIZED",
        "text": "Please retrieve token first from https://dev-dynamicsandbox-onlinebanking.cloud.OFIN.co/oauth/authorization-server"
    }
  ]
}
