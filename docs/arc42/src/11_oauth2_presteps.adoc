...
[start=1]
. Click on https://dev-dynamicsandbox-tppui.cloud.OFIN.co/login and create new TPP account. For our example we named the TPP _tppoauth_.
...
. Open following link in your browser: https://dev-dynamicsandbox-onlinebankingui.cloud.OFIN.co/auth/authorize?redirect_uri=https:%2F%2Fgoogle.com
...
. Open the OBA UI https://dev-dynamicsandbox-onlinebankingui.cloud.OFIN.co and login as user _oauth_.
